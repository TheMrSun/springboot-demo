...
public class AspectLog {
     ...
     * 定义切点
     */
    @Pointcut("@annotation(com.sunzi.demologaop.common.annotation.OperationAspectLog)")
    public void log() {
    ...
    public Object aroundLog(ProceedingJoinPoint point) throws Throwable {
        ...
        final AopLog l = AopLog.builder()
                ...
                .operationDesc(getOperationDesc(point))
                .build();
    ...
    public String getOperationDesc(ProceedingJoinPoint point){
        //获取方法签名
        MethodSignature methodSignature = (MethodSignature) point.getSignature();
        return  methodSignature.getMethod().getAnnotation(OperationAspectLog.class).operationDesc();
    }
}
